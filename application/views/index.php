...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/line-icons.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/owl.theme.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/nivo-lightbox.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/resources/assets/css/animate.css">
  ...
  <body>
    ...
    <header id="video-area" data-stellar-background-ratio="0.5">    
      <div id="block" data-vide-bg="<?php echo base_url(); ?>/resources/assets/video/video"></div>
      <div class="fixed-top">
          <div class="container">
            <div class="logo-menu">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="show-box wow fadeInDown animated" data-wow-offset="10">
              <img src="<?php echo base_url(); ?>/resources/assets/img/features/feature.jpg" alt="">
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="portfolio-item">
                  <div class="shot-item">
                    <a class="overlay lightbox" href="img/portfolio/img6.jpg">
                      <img src="<?php echo base_url(); ?>/resources/assets/img/portfolio/img6.jpg" alt="" />  
                      <i class="lnr lnr-plus-circle item-icon"></i>
                    </a>
                  </div>               
                </div>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url(); ?>/resources/assets/img/blog/img1.jpg" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.6s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url(); ?>/resources/assets/img/blog/img2.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.9s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo base_url(); ?>/resources/assets/img/blog/img3.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text">    
                <h3>
    ...
    <script src="<?php echo base_url(); ?>/resources/assets/js/tether.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>/resources/assets/js/mixitup.min.js"></script>
    <script src="<?php echo base_url(); ?>/resources/assets/js/nivo-lightbox.js"></script>
    <script src="<?php echo base_url(); ?>/resources/assets/js/owl.carousel.min.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/jquery.stellar.min.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/jquery.nav.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/smooth-scroll.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/smooth-on-scroll.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/wow.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/menu.js"></script>
    <script src="<?php echo base_url(); ?>/resources/assets/js/jquery.vide.js"></script>
    <script src="<?php echo base_url(); ?>/resources/assets/js/jquery.counterup.min.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/jquery.magnific-popup.min.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/waypoints.min.js"></script>    
    <script src="<?php echo base_url(); ?>/resources/assets/js/form-validator.min.js"></script>
    <script src="<?php echo base_url(); ?>/resources/assets/js/contact-form-script.js"></script>     
